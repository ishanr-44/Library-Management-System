    ...
    public partial class Form6 : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (row.Cells["ID"].Value != null && int.TryParse(row.Cells["ID"].Value.ToString(), out bid))
                {
                    // Parsing successful, continue with your code
                    panel2.Visible = true;
                    ...
                    cmd.CommandText = "select * from Add_Members where ID = @bid";
                    ...
                    {
                        // Assuming the column indexes are as follows:
                        // 0: mname, 1: uniid, 2: position, 3: faculty, 4: department, 5: batch, 6: contact, 7: mail, 8: username, 9: password
                        ...
                        // You can similarly populate other textboxes with relevant details
                    }
                    else
                    {
                ...
                {
                    // Handle the case where the cell value cannot be parsed as an integer
